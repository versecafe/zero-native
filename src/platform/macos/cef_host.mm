...
public:
    ...
    ZeroNativeCefClient(ZeroNativeChromiumHost *host, uint64_t window_id, std::string webview_key, bool bridge_enabled) : host_(host), window_id_(window_id), webview_key_(webview_key), bridge_enabled_(bridge_enabled) {}
